...
namespace EcommerceMVCWebApplication.Controllers
{
    public class ProductDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Category,RegistrationDate,ProductQty,Price,Password")] ProductDetails productDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Category,RegistrationDate,ProductQty,Price,Password")] ProductDetails productDetails)
        {
            if (ModelState.IsValid)
            {
